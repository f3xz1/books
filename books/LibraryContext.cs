...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=STHQ0116-07; Database=Library;User Id=admin; Password=admin");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPressNavigation)
                    .WithMany(p => p.Books)
                    .HasForeignKey(d => d.IdPress)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Books_Press");

                entity.HasOne(d => d.IdThemesNavigation)
                    .WithMany(p => p.Books)
            ...
            modelBuilder.Entity<Picture>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Pictures__BookId__6FE99F9F");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.Login).HasMaxLength(18);
